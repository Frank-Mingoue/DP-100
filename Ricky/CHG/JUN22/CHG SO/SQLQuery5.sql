...
SELECT DISTINCT 
SO.X_EXPORT_STATUS , SO.STATUS_CD , OI.QTY_REQ , OI.DLVRY_STATUS_CD ,TP.NAME, SO.X_SUB_TYPE, OI.ROW_ID , SO.ROW_ID
FROM S_ORDER SO
...
AND SO.STATUS_CD IN ('To be approved') 
...
--update S_ORDER set STATUS_CD = 'To be approved' where ROW_ID = '1-7SLTTH'

--select DLVRY_STATUS_CD from S_ORDER_ITEM where DLVRY_STATUS_CD <> 'Sent to Altadis'


--update S_ORDER set X_EXPORT_STATUS = NULL where ROW_ID = '1-7SLTTH'