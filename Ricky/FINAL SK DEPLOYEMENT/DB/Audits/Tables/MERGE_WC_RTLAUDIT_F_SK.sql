...
CREATE TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK](
	...
	[SHELF_STOCK] [numeric](18, 3) NULL,
	[TPR_FLG] [nchar](1) NULL,
	[TPR_PCT] [numeric](18, 3) NULL,
	...
	[X_EXPIRED_QTY_RECALL] [numeric](18, 3) NULL,
	...
	[X_DOMESTIC_PRICE] [numeric](18, 3) NULL,
	[X_AVAILABLE_STOCK_NUM] [numeric](18, 3) NULL,
	[X_CONTRACTED_FLG] [nvarchar](1) NULL,
	[X_EXCHANGED_LABEL_NUM] [numeric](18, 3) NULL,
...
ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [ACCT_GEO_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [EMP_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [FACING_POS_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [INVLOC_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [OBJECTIVE_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [OWNER_POSTN_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [PROD_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [RECORD_DATE_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [STORE_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [GEO_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [GEO_SEC_WID]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_RETRO_FLG]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_PMP_FLG]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_AUDIT_WRONG_FLG]
GO

ALTER TABLE [dbo].[MERGE_WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [RI_FLG]
GO
