...
ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [ACCT_GEO_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [EMP_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [FACING_POS_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [INVLOC_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [OBJECTIVE_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [OWNER_POSTN_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [PROD_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [RECORD_DATE_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [STORE_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [GEO_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ((0)) FOR [GEO_SEC_WID]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_RETRO_FLG]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_PMP_FLG]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [X_AUDIT_WRONG_FLG]
GO

ALTER TABLE [dbo].[WC_RTLAUDIT_F_SK] ADD  DEFAULT ('N') FOR [RI_FLG]
GO
